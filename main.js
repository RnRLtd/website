// Sample Products Data (Later replaced with database)
const products = [
...
document.getElementById('checkoutForm').addEventListener('submit', (e) => {
    e.preventDefault();
    alert('Order placed! Receipt will be generated.');
    // In a real app, send to backend for payment processing
    generateReceipt();
    cart = [];
    updateCart();
    document.getElementById('checkoutModal').style.display = 'none';
...
function generateReceipt() {
    ...
    console.log(receipt); // In real app, send as PDF/Email
}
